...
from flask import Blueprint, flash, make_response, redirect, request, session, url_for, render_template as real_render_template, Response # last one use for overriding and passing NAVIGATION to all templates
...
def icons():
    ...
    iconlist = [l.split('::')[0].split(':')[0].split('.')[1] for l in Lines if 'before' in l]
